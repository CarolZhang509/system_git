...
(function (global, factory) {
	...
	/**
	 * Return a dom element from either a dom query string, jQuery object, a dom element or template string
	...
	class TomSelect extends MicroPlugin(MicroEvent) {
	  ...
	  setup() {
	    ...
	    }; // store original template and tab index so that they can be
